...
public class CamerService2 extends Service implements
    ...
    Camera.PictureCallback mCall = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            SPref.storingIMAGEFilePathWithKey(sharedPreferences, SPref.IMAGE_PATH, image.toString());
            ...
            stopSelf();
           /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                startForegroundService(new Intent(getApplicationContext(), ImageCaptureService2.class));
            } else {
                startService(new Intent(getApplicationContext(), ImageCaptureService2.class));
            }*/
            startService(new Intent(getApplicationContext(), ImageCaptureService2.class));

            PowerButtonBroadCast.counter = 1;
        }
    };
