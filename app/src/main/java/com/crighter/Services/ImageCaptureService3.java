...
public class ImageCaptureService3 extends Service implements
    ...
    Camera.PictureCallback mCall = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
           ...
           /* File imagesFolder = new File(
            ...
            SPref.storingIMAGEFilePathWithKey(sharedPreferences, SPref.IMAGE_PATH3, image.toString());
            ...
            stopSelf();
           /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                startForegroundService(new Intent(getApplicationContext(), ImageCaptureService4.class));
            } else {
                startService(new Intent(getApplicationContext(), ImageCaptureService4.class));
            }*/
            startService(new Intent(getApplicationContext(), ImageCaptureService4.class));
            PowerButtonBroadCast.counter = 3;
        }
    };
