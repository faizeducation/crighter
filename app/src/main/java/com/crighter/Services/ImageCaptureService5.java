...
public class ImageCaptureService5 extends Service implements
    ...
    Camera.PictureCallback mCall = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
           ...
           /* File imagesFolder = new File(
            ...
            SPref.storingIMAGEFilePathWithKey(sharedPreferences, SPref.IMAGE_PATH5, image.toString());
            ...
            stopSelf();
            PowerButtonBroadCast.counter = 5;
        }
    };
